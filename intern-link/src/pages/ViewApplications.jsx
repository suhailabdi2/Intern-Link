        ...
        <tbody>
          {
            viewApplicationsPageData.map((application,index) =>(
              <tr key={index} className='text-gray-700'> 
                <td className='py-2 px-4 border-b text-center max-sm:hidden'>{application._id}</td>
                <td className='py-2 px-4 border-b text-center max-sm:hidden'><img className='w-10 h-10 rounded-full mr-3 max-sm:hidden' src={application.imgSrc} alt="" /><span>{application.name}</span></td>
                <td className='py-2 px-4 border-b text-center max-sm:hidden'></td>
